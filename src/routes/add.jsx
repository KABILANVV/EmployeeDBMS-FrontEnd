...
function Add() {
    ...
    return (
        ...
        <div class="form-group">
            ...
            <input aria-label="Your name" type="text" class="form-control" placeholder="Enter Id"
             value={id}
            onChange={(event) =>
              {
        ...
        <div class="form-group">
            ...
            <input type="text" aria-label="Your name" class="form-control" placeholder="Enter Emplyee Name"
             value={name}
            onChange={(event) =>
              {
        ...
        <div class="form-group">
            ...
            <input type="text" aria-label="Your name" class="form-control" placeholder="Enter Department"
             value={Dept}
            onChange={(event) =>
              {
        ...
        <div class="form-group">
            ...
            <input type="text" aria-label="Your name" class="form-control" placeholder="Enter Designation"
             value={Desig}
             onChange={(event) =>
               {
        ...
        <br></br>
       <center> <button type="submit" class="btn btn-primary mt-4"  onClick={save}>Register</button></center>
       </form>
